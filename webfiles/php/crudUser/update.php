...
if($connexion){
    ...
    <div>
    <label for="confirmationMotPass">Votre confirmation mot de passe : </label>
    ...
    <a href="../../../read.php" title="Redirection vers des utilisateur">Retourner à la page principal.</a>
    <?php 
 }
 else { ?>
        <h1>Un problème est survenue, connecter vous <a href="../auth/authLogin/connection.php">connection</a> ! </h1>
        <?php }   
    } ?>
    </body>
</html>